...
// Math.round(): Arredonda um número de ponto com casas decimais para o inteiro mais próximo.
...
// Math.ceil(): Arredonda para o valor mais alto. ( ceil -> teto )

Math.ceil(5.2) // retorna 6


// Math.floor(): Arredonda para o valor mais baixo. ( floor -> piso )

Math.floor(5.2) // retorna 5

// Math.trunc() : ignora os números decimais, o que é conhecido como truncamento.
